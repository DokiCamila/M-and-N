...
using ComparacaoDPCI.Extracao.Filters;
using ComparacaoDPCI.Extracao.Modelo;
using ComparacaoDPCI.Extracao.Minuncia;
using ComparacaoDPCI.Templates;

namespace ComparacaoDPCI.Extracao
{
    public sealed class Extrator
    {
        [DpiAdjusted]
